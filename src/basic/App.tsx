...
import { ProductWithUI, MAX_STOCK, MAX_DISCOUNT_AMOUNT, MAX_DISCOUNT_PERCENTAGE, NOTIFICATION_DURATION } from './constants';
// hooks import
...
const App = () => {
  ...
  const { products, filteredProducts, addProduct, updateProduct, deleteProduct } = useProducts(debouncedSearchTerm);
